package com.sinosoft.ops.cimp.common.word;

import com.aspose.words.Document;
import com.aspose.words.License;
import com.sinosoft.ops.cimp.common.word.data.*;
import com.sinosoft.ops.cimp.common.word.processor.*;
...
public class ExportWord {
    ...
    public ExportWord(String wordType) {
        switch (wordType) {
            case "gbrmb":
                //储存word类型
...
//			attrValueProcessorMap.put(new EvaluationAttrValue().getKey(), new EvaluationAttrValueProcessor());
    ...
    public Map<String, Object> getAllAttrValue(String empId, ExportService exportWordService) throws Exception {
        ...
        // 排序
        List<Map.Entry<String, AttrValue>> sortedList = new ArrayList<>(

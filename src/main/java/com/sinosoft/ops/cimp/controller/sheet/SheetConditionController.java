...
//        try {
//            sheetConditionService.ResolveAndSave(request,this.getCurrentLoggedInUser().getId());
...
//            }else if(sysUserService.getAllApprovedEnabledRoleIds(getCurrentLoggedInUser().getId()).contains(0)){
//            	 return ResponseResult.success(1,1);
//            }
//            else
//            {
...
//            boolean success = sheetConditionService.moveUp(entity, categoryId);
//            if (success) {
...
//            UUID categoryId = UUID.fromString(request.getParameter("categoryId"));
//            entity.setLastModifiedBy(getCurrentLoggedInUser().getId());
//            boolean success = sheetConditionService.moveDown(entity, categoryId);
//            if (success) {
...
//
//    @Override
//    public ResponseResult delete(SheetCondition entity) {

...
//import com.newskysoft.iimp.common.exception.OperationNotAllowedException;
//import com.newskysoft.iimp.sheet.model.Sheet;
//import com.newskysoft.iimp.sheet.model.SheetData;
//import com.newskysoft.iimp.sheet.model.SheetDesignDesignCategory;
//import com.newskysoft.iimp.sheet.model.SheetGatherInfo;
//import com.newskysoft.iimp.sheet.model.SheetParameter;
//import com.newskysoft.iimp.sheet.model.SheetTag;
//import com.newskysoft.iimp.sheet.service.SheetComService;
//import com.newskysoft.iimp.sheet.service.SheetDataService;
//import com.newskysoft.iimp.sheet.service.SheetDesignDesignCategoryService;
...
//import com.newskysoft.iimp.sheet.service.SheetParameterService;
//import com.newskysoft.iimp.sheet.service.SheetService;
//import com.newskysoft.iimp.sheet.service.SheetTagService;
//import com.newskysoft.iimp.system.model.SysDataSourceTable;
//import com.newskysoft.iimp.system.service.SystemUserService;
//
///**
...
//        try {
//            sheetService.updateFlagByIds(ids,Integer.parseInt(flg),getStringParam(request, "notation", null),getCurrentLoggedInUser().getId(),getCurrentLoggedInUser().getOrganizationId());
...
//            int count=sheetService.archiveByIds(uuid,ids,getCurrentLoggedInUser().getId(),getCurrentLoggedInUser().getOrganizationId());
...
//        try {
//            UUID uuid=UUID.fromString(categoryId);
//            int count=sheetService.unarchiveByIds(uuid,ids,getCurrentLoggedInUser().getId(),getCurrentLoggedInUser().getOrganizationId());
...
//            	// 1 单位   2 党组织
//            	if(param==1){
//            		organizationIds = systemUserService.getTreeOrganizationIds(this.getCurrentLoggedInUser().getId(), "DepTree");
//
//            	}else if(param==2){
//            		organizationIds = systemUserService.getTreeOrganizationIds(this.getCurrentLoggedInUser().getId(), "PartyTree");
//            	}else{
//            		organizationIds=new ArrayList<>();
//            	}
//            	queryParameter.getParameters().put("depIds", organizationIds);
//            	logger.debug("报表列表 param："+param);
//            	logger.debug("报表列表 userId："+this.getCurrentLoggedInUser().getId().toString());
...
//            return ResponseResult.success(queryResult.getData(), queryResult.getTotalCount());
//        } catch (Exception e) {
//            logger.error("查询数据失败！用户id为："+this.getCurrentLoggedInUser().getId(), e);
//            return ResponseResult.failure("查询数据失败！");
//        }
//    }
//
...
//				//添加汇总标记
//				sheetComService.addGatherSign(getCurrentLoggedInUser().getId().toString(),id);
//				List<Map<String,Object>> list = sheetComService.formulaCaculation(id, sheet.getDesignId().toString(),getCurrentLoggedInUser().getId(), (List<SheetData>)gatherDatas);
...
//			//}
//			//移除汇总标记
//			sheetComService.removeGatherSign(getCurrentLoggedInUser().getId().toString(),id);
